...
<h1><img src="<?= base_url('assets/imgs/filemanager.png') ?>" class="header-img"> Gerenciador de Arquivos</h1>
<p>Aqui você pode listar todos os arquivos do site</p>
<hr>
<div class="alert alert-danger">Zona de perigo! Não toque se não tiver certeza!</div>
<div id="elfinder"></div>